  ...
  return {
    ...
    errorMessages: {
      ...
      [HOST_ERROR]: {
        ...
        fa: `میزبان URL معتبر نیست. میزبان های مجاز عبارتند از: ${options?.allowedHosts?.join(', ')}`,
      ...
      [PROTOCOL_ERROR]: {
        ...
        fa: `پروتکل URL معتبر نیست. پروتکل های مجاز عبارتند از: ${options?.allowedProtocols?.join(', ')}`,
